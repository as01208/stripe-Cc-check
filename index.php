          ...
          <div class="profile-desc">
            <div class="profile-pic">
              ...
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal">🐉DRAGON-BIN</h5>
        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
              <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/teambyte_xyz">Welcome By 🐉DRAGON-BIN </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                <div class="navbar-profile">
                  <img class="img-xs rounded-circle" src="face15.jpg" alt="">
                  <p class="mb-0 d-none d-sm-block navbar-profile-name">🐉DRAGON-BIN</p>
                ...
                <footer class="footer">
                  <div class="footer__block block no-margin-bottom">
                    <div class="container-fluid text-center">
                      ...
                      <p class="no-margin-bottom">2021 &copy; Your company. Design by <a href="https://telegram.dog/DragonBin">🐉DRAGON-BIN</a>.</p>
                    </div>
                  </div>
                </footer>
                <!-- partial -->
